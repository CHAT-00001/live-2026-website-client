...
<div class="comment-send">
    ...
    <textarea class="send_bar" bind:value={text} placeholder="Write a comment..."></textarea>
    <message>你还可以输入{count}个字符!</message>
    <media>
        <div class="video">
            <div class="audio"><button>开始录音⏺️</button></div>
        </div>
        <div class="thumb"><button>添加照片</button></div>
